...
export default function NavbarComponent() {
  return (
    <div>
      <nav class="absolute top-0 w-screen border-gray-200 dark:bg-gray-900">
          ...
          <div class="hidden w-full bg-transparent md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
                  class="block text-white py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0 dark:text-white md:dark:text-blue-500 drop-shadow-lg"
                  aria-current="page"
                >
                  Home
                </a>
